...
class Planner:
    def  __init__(self, state_validity_checker, max_time = 5.0, delta_q=2, p_goal=0.5, dominion=[-10, 10, -10, 10]):
        # define constructor
